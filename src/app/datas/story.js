import ListImages from "@/components/qui-sommes-nous/listImages";
    ...
    content: (
      <div>
        <p className=" mb-8">
          ...
          avec l&apos;acquisition de Carrara dans l&apos;Est de la France, pour
          offrir encore plus de proximité, de réactivité et d&apos;expertise.
        </p>
        <ListImages
          images={[
            {
            ...
            {
              title: "logo de Carrara",
              url: "/images/logos/carrara/Logo_CARRARA_fin.png",
            },
          ]}
        />
      </div>

...
const Slide = ({ slide, index, current, handleSlideClick }) => {
  ...
  return (
    <div className="[perspective:1200px] [transform-style:preserve-3d]">
      ...
      >
        <div
          className="absolute top-0 left-0 w-full h-full bg-secondary rounded-3xl overflow-hidden transition-all duration-150 ease-out"
          style={{
            transform:
              current === index
...
const CarouselControl = ({ type, title, handleClick }) => {
  return (
    <button
      className={`w-10 h-10 flex items-center mx-2 justify-center bg-secondary border-3 border-transparent rounded-full focus:border-or-light focus:outline-none hover:-translate-y-0.5 active:translate-y-0.5 transition duration-200 ${

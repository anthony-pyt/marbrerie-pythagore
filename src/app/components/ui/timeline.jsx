...
export const Timeline = ({ data }) => {
  ...
  return (
    ...
    >
      ...
      <div ref={ref} className="relative max-w-7xl pb-44">
        {data.map((item, index) => (
          <div
            key={index}
        ...
        >
          <motion.div
            ...
            className="absolute inset-x-0 top-0 w-[2px] bg-gradient-to-t from-or via-or to-transparent from-[0%] via-[10%] rounded-full"
          />
        </div>
      </div>
    </div>
